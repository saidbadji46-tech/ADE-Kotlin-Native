...
/**
 * دالة تجزئة (hash) بسيطة بلا أي مكتبة خارجية — كافية لتفادي تخزين رمز PIN
 * كنص صريح محلياً، ماشي تشفير قوي أمنياً (ما محتاجينهوش هنا، الرمز مخزّن
 * محلياً فقط على جهاز العامل). كانت مستعملة فـ setupPin()/tryUnlock() بلا
 * ما تكون معرّفة — هذا هو سبب فشل البناء (Unresolved reference: simpleHash).
 */
